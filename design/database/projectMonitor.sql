...
DROP SEQUENCE IF EXISTS public.mst_departments_id_seq;
DROP SEQUENCE IF EXISTS public.mst_payments_id_seq;
DROP SEQUENCE IF EXISTS public.mst_projects_id_seq;
DROP SEQUENCE IF EXISTS public.mst_workers_id_seq;
DROP SEQUENCE IF EXISTS public.trn_planed_id_seq;
DROP SEQUENCE IF EXISTS public.trn_project_orders_id_seq;
DROP SEQUENCE IF EXISTS public.trn_worked_id_seq;
